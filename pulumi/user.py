...
class User:
    ...
    def __post_init__(self):
        ...
        self.groups = list(OrderedDict.fromkeys(self.groups))
    ...
    def to_wlm(self) -> dict[str, Any]:
        wlm_user = dict(name=self.name, groups=self.groups, default_group=self.default_group)
        if self.default_group is None and len(self.groups) > 0:
            wlm_user['default_group'] = self.groups[0]
        return wlm_user
